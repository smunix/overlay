...
SRC_URI="http://ftp.digitalmars.com/dmd.${PV}.zip
		http://www.dsource.org/projects/phobos/browser/branches/phobos-1.x/phobos/std/math.d?rev=1174&format=raw -> math.d"
...
src_unpack() {
	...
	cp "${DISTDIR}"/math.d "${S}/dmd/src/phobos/std/math.d"
}
